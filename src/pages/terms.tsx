...
A. The EMUAI App is a collection of 5940 unique digital 100X100 pixels squares, each represented by an NFT.

B. The EMU NFTs are sold during a sales period starting on July 8 2021 and ending on October 1 2022 or when the NFTs are sold out and at the price displayed at the website (https://www.emuai-nft.io) This dates are subject to change. All unsold EMUs during the initial sales period will remain unsold and the physical and virtual space will stay as EMUAI's property.

C. You can access the App via any web browser using the URL https://www.myemus.info and an electronic Ethereum wallet compatible with the NFT standard on the Ethereum network, such as the MetaMask wallet. You will not be able to engage in any transactions on the App other than through MetaMask, or other Ethereum-compatible browsers.
...
F. The EMUs are digital and physical spaces on the EMUAI's future car's surface and present digital form respectively and serve no purpose other than that of displaying a 100x100 pixels picture that the owner of the NFT chooses, according to this terms and conditions.

G. EMUs are linked to a 100x100 picture that the owner of the EMU can choose. This picture must not contravene any copyright law nor go against good customs (like showing naked people or having offensive content). We do not own any of these pictures and have no right over them. They are the users responsibility.

2. PAYMENT

A. If you decide to purchase a EMU from the contract, any financial transactions will be conducted solely through the Ethereum network. We have no control over these payments or transactions, nor do we have the ability to reverse any transactions. With that in mind, the company will have no liability to you or to any third party for any claims or damages that may arise as a result of any transactions that you engage in via the App, or using the Smart Contracts, or any other transactions that you conduct via the Ethereum network.
...
D. All paid prices exclude any possible duties or charges. You will be solely responsible to pay any and all sales, use, value-added and other taxes, duties, and assessments now or hereafter claimed or imposed by any governmental authority (collectively, “Taxes”) associated with your use of the App (including, without limitation, any Taxes that may become payable as the result of your ownership of an EMU. Except for income and net-wealth taxes levied on The Company , you: (i) will pay or reimburse us for all national, federal, state, local or other taxes and assessments of any jurisdiction, including value added taxes and taxes as required by international tax treaties, customs or other import or export taxes, and amounts levied in lieu thereof based on charges set, services performed or payments made hereunder, as are now or hereafter may be imposed under the authority of any national, state, local or any other taxing jurisdiction; and (ii) shall not be entitled to deduct the amount of any such taxes, duties or assessments from payments made to us pursuant to these Terms. You confirm that you are not a resident in Switzerland or the United States nor are you registered for Goods and services tax in Switzerland or the United States.
...
You further confirm not to be resident of, citizen of or located in a geographic area that is subject to UN-, US-, EU-, Swiss embargoes. You confirm not to be resident in Switzerland or the United States. You confirm to not be domiciled in or organized under the laws of any country, whose legislation conflicts with the present purchase of NFTs on the Ethereum blockchain or the purpose of The Company in general. You agree that you may not, nor permit any third party to do or attempt to do any of the foregoing without The Company ’s express prior written consent in each case: (ii) use the EMU in connection with images, videos, or other forms of media that depict hatred, intolerance, violence, cruelty, or anything else that could reasonably be found to constitute hate speech or otherwise infringe upon the rights of others; (iii) sell, distribute for commercial gain (including, without limitation, giving away in the hopes of eventual commercial gain), or otherwise commercialize merchandise that includes, contains, or consists of the purchased EMUs, except as expressly permitted in these Terms; (iv) attempt to trademark, copyright, or otherwise acquire additional intellectual property rights in or to the purchased EMUs; or (e.g., licensed intellectual property from a celebrity, athlete, or other public figure), you understand and agree as follows: (v) that you will not have the right to use such Third Party IP in any way, and subject to the license and restrictions contained herein; (x) that, depending on the nature of the license granted from the owner of the Third Party IP, The Company may need to pass through additional restrictions on your ability to use the Art; and (z) to the extent that The Company informs you of such additional restrictions in writing (email is permissible), you will be responsible for complying with all such restrictions from the date that you receive the notice, and that failure to do so will be deemed a breach of this license. The restrictions in this Section will survive the expiration or termination of these Terms.
...
B. You are solely responsible for determining what, if any, Taxes apply to your EMUs-related transactions. The Company is not responsible for determining the Taxes that apply to your transactions on the App, the Site, or the Smart Contracts.

C. The App does not store, send, or receive EMUs. This is because EMUs exist only by virtue of the ownership record maintained on the App’s supporting blockchain in the Ethereum network. Any transfer of EMUs occurs within the supporting blockchain in the Ethereum network, and not on the App.

D. The prices of blockchain assets are very volatile. Fluctuations in the price of other digital assets could materially and adversely affect the value of your EMUs, which may also be subject to significant price volatility. We cannot guarantee that any purchasers of EMUs will not lose money.
...
F. The regulatory regime governing blockchain technologies, cryptocurrencies, and tokens is uncertain, and new regulations or policies may materially adversely affect the development of the EMUs ecosystem, and therefore the potential utility or value of EMUs.

G. Upgrades by Ethereum to the Ethereum platform, a hard fork in the Ethereum platform, or a change in how transactions are confirmed on the Ethereum platform may have unintended, adverse effects on all blockchains using the ERC-721 standard, including the EMUs ecosystem.
...
You agree to the collection, use, storage, and disclosure of your data.
